...
pairs = [
    ...
    [r"(.*) your name ?", ["My name is ABHI AI ROBOT, but you can just call me robot and I'm a chatbot .",]],
    ...
    [r"(.*)created(.*)", ["Abhishek Kumar created me using Python's NLTK library", "It's Top secret 🤫",]],
...
st.title("🤖Chatbot: ABHI AI ROBOT")
...
if user_input:
    ...
    if user_input.lower() == "quit":
        bot_response = "Goodbye! IT WAS NICE CHATTING WITH YOU, ABHI AI ROBOT IS ALWAYS HERE."
    else:
        bot_response = chat.respond(user_input)
        
    st.session_state.chat_history.append(("ABHI AI ROBOT",bot_response))        
...
st.markdown(
    ...
    <div style="text-align: center; color: gray; font-size: 12px;">
        This Bot is created/Develop by <b>Abhishek ❤</b>
    </div>
